...
namespace ProjecToxfordApi.Controllers
{
    public class WeixinController : ApiController
    {
        ...
        private const string APPID = "wxf50efbf6793dd40b";
        private const string APPSECRET = "c8357d7f60d0a93288407fc0de2ad7d9";
        ...
        public HttpResponseMessage Get(string signature, string timestamp, string nonce, string echostr)
        {
            ...
            var result = FormsAuthentication.HashPasswordForStoringInConfigFile(tmpStr, "SHAI").ToLower();
                               
            return new HttpResponseMessage()
            {
                Content = new StringContent(tmpStr, Encoding.GetEncoding("UTF-8"), "application/x-www-form-urlencoded")
            };
        }
        ...
        /// </summary>
        /// <param name="mediaid">A4BG2I_jAk71lfPzk0gxfQApgoeJNN0mMo0qLS7jcCjgldJ23kupHAnjljzl0Rs3</param>
        /// <returns></returns>
